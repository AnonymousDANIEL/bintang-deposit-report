...
def test_exact_layout_and_future_zero_rows():
    cfg = SimpleNamespace(
        target_count=3500,
        target_deposit=Decimal("60000"),
    ...
    assert msg.startswith("Bintang44 Deposit Report")
    ...
    assert "0300 -    0 | RM       0.00 | TOTAL:    0 / RM 0.00" in msg
    assert "2300 -    0 | RM       0.00 | TOTAL:    0 / RM 0.00" in msg
    assert "0000 -    0 | RM       0.00 | TOTAL:    0 / RM 0.00" in msg
